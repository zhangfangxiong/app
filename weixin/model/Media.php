...
class Media extends ModelBase
{
    ...
    const UPDATEPERMANENTNEWS = "https://api.weixin.qq.com/cgi-bin/material/update_news";//修改永久素材
     ...
     * @param $aData
     */
    public static function updateNewsFile($sToken, $aData)
    {
        $aFile = urldecode(json_encode($aData));//中文解码
        $sUploadUrl = self::UPDATEPERMANENTNEWS . "?access_token=" . $sToken;
